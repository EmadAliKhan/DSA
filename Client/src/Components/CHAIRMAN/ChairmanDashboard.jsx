...
import Requests from "../DSA/Dashboard/Requests";
import ChairmanRequest from "./ChairmanRequest";
        ...
        <Toolbar>
          ...
          >
            <span className="jacques-francois-shadow-regular">
              <b>Chairman</b> <span className="fw-light">Dashboard</span>
            </span>
          </Typography>
        </Toolbar>
      </AppBar>
